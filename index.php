				...
				<div class="row">
					<div class="col-md-12">	
						<div class="col-md-6">
		        			...
		        			<input placeholder = "Rio de Janeiro - RJ / Rua da Conceição, Rio de Janeiro - RJ" type="text" style="width: 100%"  class="form-control" id="txtDestino" />
						</div>	
						<div class="col-md-6">
						    <label for="txtDestino">Endereço de destino: </label>
				        	<input placeholder = "São Paulo - SP / Rua Oscar Freire, São Paulo - SP" type="text" id="txtOrigem" class="form-control" style="width: 100%" />
						</div>
					</div>
				</div>
				...
				<div class="row">
					<div class="col-md-12">
						<div class="col-md-6">
							...
							<input type="text" id="txtConsumo" class="form-control" style="width: 100%" />
						</div>
						<div class="col-md-6">
							<label for="txtPrecoCombustivel">Preço do combustível (R$): </label>
							<input  type="text" id="txtPrecoCombustivel" class="form-control" style="width: 100%" />
						</div>
					</div>
				</div>
