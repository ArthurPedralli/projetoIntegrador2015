					...
					<div class="row">
						<div class="col-md-12 form-group">
							<div class="col-md-6">
					        	...
					        	<input placeholder = "São Paulo - SP / Rua Oscar Freire, São Paulo - SP" type="text" id="txtOrigem" name="txtOrigem" class="form-control" required/>
							</div>
							<div class="col-md-6">
					        	<label for="txtDestino">Endereço de destino: </label>
			        			<input placeholder = "Rio de Janeiro - RJ / Rua da Conceição, Rio de Janeiro - RJ" type="text"  class="form-control" id="txtDestino" name="txtDestino" required/>
							</div>
						</div>
					</div>
